...
const Hero = () => {
  ...
  <h1 className="text-7xl -tracking-normal font-bold leading-tight">
    Learning
    <span className="ml-4 bg-linear-to-r from-green-400 to-blue-500 bg-clip-text text-transparent">
      Reimagined
    </span>
  </h1>
...
<div className='flex justify-center items-center gap-6'>
  ...
  className="mt-10 px-8 py-4 rounded-full bg-white text-black text-lg border hover:scale-105 cursor-pointer">
    Features
  </button>
